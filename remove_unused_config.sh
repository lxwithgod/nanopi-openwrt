...
[ -f configs/config_rk3399 ] && echo -e '\nCONFIG_KERNEL_BUILD_USER="ViNew"\nCONFIG_GRUB_TITLE="OpenWrt on Nanopi devices compiled by ViNew"' >> configs/config_rk3399
[ -f configs/config_rk3328 ] && echo -e '\nCONFIG_KERNEL_BUILD_USER="ViNew"\nCONFIG_GRUB_TITLE="OpenWrt on Nanopi devices compiled by ViNew"' >> configs/config_rk3328
[ -f configs/config_h5 ]     && echo -e '\nCONFIG_KERNEL_BUILD_USER="ViNew"\nCONFIG_GRUB_TITLE="OpenWrt on Nanopi devices compiled by ViNew"' >> configs/config_h5
[ -f configs/config_h3 ]     && echo -e '\nCONFIG_KERNEL_BUILD_USER="ViNew"\nCONFIG_GRUB_TITLE="OpenWrt on Nanopi devices compiled by ViNew"' >> configs/config_h3
